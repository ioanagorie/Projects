...
public class SpriteSheet
{
    ...
    private static final int    tileWidth   = 100;   /*!< Latimea unei dale din sprite sheet.*/
    private static final int    tileHeight  = 100;   /*!< Inaltime unei dale din sprite sheet.*/
    ...
    public BufferedImage crop2(int x, int y)
    {
        ...
        /// al imaginii si apoi latimea si inaltimea (totul in pixeli). Coltul din stanga sus al imaginii
        /// se obtine inmultind numarul de ordine al dalei cu dimensiunea in pixeli a unei dale.
        return spriteSheet.getSubimage(2*x * tileWidth, y * tileHeight, tileWidth*2, tileHeight);
    }
}
