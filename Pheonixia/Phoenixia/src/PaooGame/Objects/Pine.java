...
/*!\class Pine
   \brief Clasa Pine implementeaza notiunea de obstacol.
 */
public class Pine extends Personaj {
    ...
    /*! \fn public Pine(Handler handler, float x, float y, int width, int height)
           \brief Constructorul de initializare al clasei Pine.
        ...
        */
    public Pine(Handler handler, float x, float y, int width, int height) {
