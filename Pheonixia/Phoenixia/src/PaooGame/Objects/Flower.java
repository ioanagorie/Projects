...
/*!\class Flower
   \brief Clasa Flower implementeaza notiunea de obstacol.
 */
public class Flower extends Personaj {
    ...
    /*! \fn public Flower(Handler handler, float x, float y, int width, int height)
        \brief Constructorul de initializare al clasei Flower.
     ...
     */
    public Flower(Handler handler, float x, float y, int width, int height) {
    ...
    */
    ...
    /*! \fn public void Draw(Graphics g)
       \brief Randeaza/deseneaza obstacolul in noua pozitie.

       \param g Contextul grafic in care trebuie efectuata desenarea obstacolului.
    */
