...
/*!\class Tree
   \brief Clasa Tree implementeaza notiunea de obstacol.
 */
public class Tree extends Personaj {
    ...
    /*! \fn public Tree(Handler handler, float x, float y, int width, int height)
           \brief Constructorul de initializare al clasei Tree.
