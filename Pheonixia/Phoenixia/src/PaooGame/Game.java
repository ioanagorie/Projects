...
public class Game implements Runnable {
    ...
    ///Stari valabile
    public State playState;            /*!< Referinta catre nivelul 1 al jocului.*/
    public State playState2;           /*!< Referinta catre nivelul 2 al jocului.*/
    public State menuState;            /*!< Referinta catre menu.*/
    public State loadState;
    private State aboutState;          /*!< Referinta catre about.*/
    private State winState;            /*!< Referinta catre starea de nivel 1 castigat.*/
    private State winState2;           /*!< Referinta catre starea de nivel 2 si joc complet castigat.*/
    public State gameOverState;        /*!< Referinta catre starea de joc pierdut.*/
    ...
    private void InitGame() {
        ...
        Assets.Init();
        ///Se construieste obiectul de tip shortcut ce va retine o serie de referinte catre elementele utile din program.
        handler = new Handler(this);
        ///Definirea starilor programului
        playState = new PlayState(handler);
        playState2 = new PlayState2(handler);
        menuState = new MenuState(handler);
        loadState= new LoadState(handler);
        aboutState = new AboutState(handler);
        winState = new WinState(handler);
        winState2 = new WinState2(handler);
    ...
    /*! \fn public State getPlayState()
          \brief Returneaza playState pentru a fi putea folosit in alte clase.
                 Util atunci cand schimbam state-ul in PlayState (primul nivel al jocului)
     */
    public State getPlayState() {
        return playState;
    }
    /*! \fn public State getPlayState2()
          \brief Returneaza playState2 pentru a fi putea folosit in alte clase.
                 Util atunci cand schimbam state-ul in PlayState2 (primul nivel al jocului)
     */
    public State getPlayState2() {
        return playState2;
    }
    ...
    /*! \fn public State getLoadState()
         \brief Returneaza aboutState pentru a fi putea folosit in alte clase.
                Util atunci cand schimbam state-ul in LoadState.
    */
    ...
    /*! \fn public State getWinState()
         \brief Returneaza winState pentru a fi putea folosit in alte clase.
                Util atunci cand schimbam state-ul in WinState.
      */
    public State getWinState() {
        return winState;
    }
    /*! \fn public State getWinState2()
        \brief Returneaza winState2 pentru a fi putea folosit in alte clase.
               Util atunci cand schimbam state-ul in WinState2.
     */
    public State getWinState2() {
        return winState2;
    }
     /*! \fn public State getGameOverState()
         \brief Returneaza GameOverState pentru a fi putea folosit in alte clase.
                Util atunci cand schimbam state-ul in GameOverState.
      */
